            ...
            <form name= "ticket" METHOD="POST">
                <center>
                    ...
                    <div>
                        ...
                        <tbody>
                        <tr>
                        <td><p style="text-align:left;">Receipt Number: </td> </p>
                        <td colspan="2"><%=session.getAttribute("transaction_id") %></td>
                        </tr>
                          <tr>
                    <td rowspan="3"><p><img src="<%=session.getAttribute("movie_poster") %>" width="300" height="200" /></p></td>
                    </tr>
                    <tr>
                      <td colspan="2">  </td>
                     </tr>
                    <tr>				
                        ...
                        <%=session.getAttribute("date") %><br>
                        at: <%=session.getAttribute("slot") %>
                        </td>
                     ...
                     <tr>
                     <td>   <p style="text-align:left;">Seat Number: </p></td>
                     <td colspan="2"><%=session.getAttribute("current_seats")%></td>
                     </tr>
                    <tr></tr>
                    <tr><td style="text-align:left;"><h2>Summary</h2></td></tr>
                    <tr>
                ...
                <footer>
                    <p style="text-align:Center;"><h2>Thank you!</h2></p>
                </footer>
                </div>
            </form>
            </center>
